...
To make it work on my system I need to slightly modify deepqnetwork.py from https://github.com/NervanaSystems/simple_dqn, and write a small script in WeightTransform.py to transform the deprecated format for neural network weights to a new format.
